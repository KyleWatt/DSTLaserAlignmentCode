...
power_t get_latest_power() {
    ...
    // result = shared_power;
    // mutex_exit(&power_mutex);
    result.power_A = 0.0f; // Placeholder for actual power reading
    result.power_B = 0.0f; // Placeholder for actual power reading 
    result.power_C = 0.0f; // Placeholder for actual power reading
    result.power_D = 0.0f; // Placeholder for actual power readin
    return result;
}